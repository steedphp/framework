...
use Steed\Http\Message\ServerRequest;
use Steed\Http\Message\Stream;
use Steed\Http\Message\UploadFile;
use Steed\Http\Message\Uri;

class Request extends ServerRequest
{
    private $request;

    function __construct(\Swoole\Http\Request $request)
    {
